...
#                                  |                               .m.                                  ,_                                                 #
# Title        : AcidBurn          |                              ' ;M;                                ,;m `                                               #
# Author       : JaBootii          |                                ;M;.           ,      ,           ;SMM;                                                #
# Version      : 1.0               |                               ;;Mm;         ,;  ____  ;,         ;SMM;                                                #
# Category     : Prank             |                              ;;;MM;        ; (.MMMMMM.) ;       ,SSMM;;                                               #
# Target       : Windows 7,10,11   |                            ,;;;mMp'        l  ';mmmm;/  j       SSSMM;;                                               #
# Mode         : HID               |                          .;;;;;MM;         .\,.mmSSSm,,/,      ,SSSMM;;;                                              #
...
#----------------------------------------------------------------------------------------------------
    ...
    $goodRAM = "$RAM gigs of ram? wow boi, did apple make that too?"

    $impressiveRAM = "$RAM gigs of ram? are you serious? a super computer with no security that is funny right there. does your wife know you have this kind of computer for "finance"?"
#----------------------------------------------------------------------------------------------------
...
# ENTER YOUR CUSTOM RESPONSES HERE
#----------------------------------------------------------------------------------------------------
    $badPASS = "truly expected better from you. $pro is not a very creative name but at least it is not as bad as your wifi password... only $pwl characters long? $pass ...? really..? $pass was the best you could come up with?"
